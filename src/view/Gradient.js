...
export default function Gradient() {
    ...
    return(
        <div    className="w-100 d-flex align-items-center justify-content-center flex-column"      style={{height: "100vh",
                                                                                                background: "linear-gradient(" + deg + "deg, " + colorsList[0].hexa + " , " + colorsList[1].hexa + " , " + colorsList[2].hexa + " )", 
                                                                                                background: "-moz-linear-gradient(" + deg + "deg, " + colorsList[0].hexa + " , " + colorsList[1].hexa + " , " + colorsList[2].hexa + " )",
                                                                                                background: "-webkit-linear-gradient(" + deg + "deg, " + colorsList[0].hexa + " , " + colorsList[1].hexa + " , " + colorsList[2].hexa + " )"}}>
